...
@Component({
  ...
  template: `
    <div style="display:flex;flex-direction:column;gap:1rem;width:100%;max-width:40rem">
      ...
      <div
        style="position:relative;height:8rem;overflow:hidden;padding:1rem;border:1px dashed var(--color-neutral-stroke-rest);border-radius:1rem;background:linear-gradient(180deg,var(--color-neutral-background2-rest),var(--color-neutral-background1-rest))"
      >
