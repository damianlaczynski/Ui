          ...
          >
            <div style="display:flex;flex-direction:column;gap:0.625rem">
              @for (item of items; track item.id) {
                <div
                  style="padding:0.75rem 0.875rem;border:1px solid var(--color-neutral-stroke-rest);border-radius:0.75rem;background:var(--color-neutral-background1-rest);font-size:0.8125rem"
                >
                  {{ item.label }}
                </div>
              }
