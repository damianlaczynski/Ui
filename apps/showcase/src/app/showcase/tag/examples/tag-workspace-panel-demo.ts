    ...
    >
      <div style="display:flex;flex-direction:column;gap:0.375rem">
        ...
        <div style="font-size:0.875rem;color:var(--color-neutral-foreground2-rest);line-height:1.45">
          Tags often work best as compact metadata inside a richer surface, not as isolated decorative chips.
        </div>
      </div>

      <div style="display:flex;flex-wrap:wrap;gap:0.75rem;align-items:flex-start">
        <ui-tag text="Enterprise" appearance="filled" variant="secondary" icon="building_bank_toolbox" />
        ...
        <ui-tag text="Tracked" secondaryText="JIRA-214" appearance="outline" variant="info" icon="ticket_diagonal" />
      </div>
